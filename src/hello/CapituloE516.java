...
public class CapituloE516 extends JFrame implements ActionListener  {
    
    private JButton button;
    private JPanel panel;
    
    public static void main(String[] args){
        CapituloE516 marco = new CapituloE516();
    ...
    private void dibujarCirculo(Graphics areaDibujo, int xCentro, int yCentro, int radio) {
        ...
        this.dibujarCirculo2( papel, x,  y);
    }

    private void dibujarCirculo2(Graphics areaDibujo, int x, int y) {
       areaDibujo.drawOval(x, y, 50, 50);
    }
