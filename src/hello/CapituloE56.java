 ...
 * @author CREYES
 */
public class CapituloE56 extends JFrame implements ActionListener {
    
    private JButton button;
    private JPanel panel;
    
    public static void main(String[] args){
        CapituloE56 marco = new CapituloE56();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        dibujarCalleEnPerspectiva(papel,0,155,390,30);     
    }
    private void dibujarCalleEnPerspectiva(Graphics papel, int xCalle, int yCalle, int wCalle, int hCalle) {
        
        papel.fillRect(xCalle, yCalle, wCalle, hCalle);
        papel.setColor(Color.black);
        dibujarCasa(papel, 10, 50, 50, 50);
        dibujarCasa(papel, 90, 50, 40, 40);
        dibujarCasa(papel, 170, 50, 32, 32);
        dibujarCasa(papel, 250, 50, 25, 25);
